...
export default defineConfig({
  ...
  build: {
    lib: {
      ...
      entry: { Viewport: 'src/Viewport.jsx', toolpath_reexport: 'src/toolpath_reexport.js', model_loaders: 'src/scene/model_loaders.js', gcode_reexport: 'src/gcode_reexport.js', 'parse_3mf.worker': 'src/parse_3mf.worker.js', 'sla_reconstruct.worker': 'src/sla_reconstruct.worker.js', 'sla_slice.worker': 'src/sla_slice.worker.js', 'sl1_encode.worker': 'src/sl1_encode.worker.js' },
      formats: ['es'],
    },
    outDir: 'dist',
    rollupOptions: {
