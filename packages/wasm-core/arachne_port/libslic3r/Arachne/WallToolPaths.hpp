...
#include <boost/container_hash/hash.hpp>   // STAGE-7 PORT MOD: boost::hash<std::pair<...>> for ExtrusionLineSet (normally pulled transitively via a header stubbed out in the port)
