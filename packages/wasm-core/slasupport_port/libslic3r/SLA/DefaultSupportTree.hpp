...
public:
    ...
    // PORT-EDIT: ring steps 45 -> 16. The display default meshes ~3x more triangles than the wasm raster sweep,
    //  the structured-clone transfer and the viewer can afford; 16 is visually identical at pillar radii.
    inline void merge_result() { m_builder.merged_mesh(16); }
