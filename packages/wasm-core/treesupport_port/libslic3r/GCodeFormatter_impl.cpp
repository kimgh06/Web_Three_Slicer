// STAGE-8 PORT: GCodeFormatter::emit_axis definition extracted from src/libslic3r/GCodeWriter.cpp
// (unchanged). On wasm (non-__APPLE__) it uses std::to_chars — no boost::spirit needed.
