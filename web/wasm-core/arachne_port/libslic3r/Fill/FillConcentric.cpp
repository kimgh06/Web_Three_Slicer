    ...
    ThickPolylines& thick_polylines_out)
{
    ...
    if (params.density > 0.9999f && !params.dont_adjust) {
        ...
        // STAGE-8 PORT MOD: original reads print_config->nozzle_diameter (full PrintConfig, stubbed).
        // Port has no PrintConfig; use fixed 0.4mm nozzle. Only the 100%-density concentric branch.
        double min_nozzle_diameter = 0.4;
