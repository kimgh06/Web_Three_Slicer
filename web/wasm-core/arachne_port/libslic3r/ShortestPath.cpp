...
#include "ExPolygon.hpp"   // STAGE-8 PORT MOD: was transitively pulled by the removed Print.hpp include
#include "BoundingBox.hpp" // STAGE-8 PORT MOD: ditto
...
// BBS
// STAGE-8 PORT MOD: chain_print_object_instances stubbed (needs Print.hpp; unused by Fill).
