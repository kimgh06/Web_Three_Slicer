...
// (stage 16) inline tbb::scalable_allocator alias — the oneapi/tbb/scalable_allocator.h stub lookup
// flakes non-deterministically in the em++ FS sandbox on large TUs; inlining the alias (guarded so it
// is defined once even when Point.hpp + SupportLayer.hpp share a TU) removes the fragile file lookup.
#ifndef SLIC3R_TBB_SCALABLE_ALLOC_STUB
#define SLIC3R_TBB_SCALABLE_ALLOC_STUB
#include <memory>
